---
title: "დავალება 0.2 - შინაგანი ხმა - Indoor Voice"
order: 1102
videoUrl: ""
videoDuration: ""
isPreview: false
...
თუმცა ალბათ დამეთანხმებით რომ სჯობს ვაკონტროლოთ ემოციები, მოვუხმოთ შინაგან ხმას, მესიჯები და კომენტარები ვწეროთ გაწონასწორებულად.
...
- გაიხსენე რომ `str` - ს აქვს საკმაოდ ბევრი სასარგებლო მეთოდი და გადახედე შესაბამის დოკუმენტაციას: [docs.python.org/3/library/stdtypes.html#string-methods](https://docs.python.org/3/library/stdtypes.html#string-methods)
...
4. ახლა ამ ფოლდერში შექმენი ფაილი სახელად `indoor.py`  ბრძანებით `code indoor.py`
...
თუ რაიმე პრობლემას წააწყდები, მაგალითად file cannot be opened ან რაიმე მსგავსი, ნაბიჯ-ნაბიჯ მიჰყევი ზემოთ მოცემულ ინსტრუქციებს და დარწმუნდი რომ indoor ფოლდერი შექმნილია. ასევე დარწმუნდი რომ indoor.py ფაილიც შექმნილია და ასევე დარწმუნდი რომ ნამდვილად შესული ხარ indoor ფოლდერში.
