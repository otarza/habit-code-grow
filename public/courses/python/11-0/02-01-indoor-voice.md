...
შექმენით ფაილი სახელად `indoor.py` და დაწერეთ პროგრამა რომელიც მომხმარებელს ჰკითხავს რაიმე ტექსტის შეყვანას, პასუხად კი დაუბრუნებს ამ ტექსტის lowercase(პატარა ასოებით შედგენილ) ვერსიას.
...
4. ახლა ამ ფოლდერში შექმენი ფაილი სახელად `indoor.py` - ამ ბრძანების გამოყენებით `code indoor.py`
