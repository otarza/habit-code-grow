...
const faqs = [
  ...
  },
  {
    ...
    a: "26 მაისს 23:59 საათზე მთავარი დამოუკიდებლობის ტაიმერი ჩერდება. საბანკო გადახდების შეფერხების გამო, ₾99 ფასი გახანგრძლივდა დამატებითი ოვერტაიმით 27 მაისის 14:59-მდე.",
  },
  {
...
function getTimingCopy(timing: CampaignCountdownState) {
  if (timing.phase === "overtime") {
    return {
      ...
      value: "ოვერტაიმი 14:59-მდე",
      note: "საბანკო შეფერხება მოგვარდა — ₾99 ფასი დამატებით 12 საათით დარჩა აქტიური.",
    };
  }
        ...
        <section className="campaign-hero">
          <div className="campaign-shell campaign-hero__grid">
            <div className="campaign-hero__copy">
              <p className="campaign-eyebrow">საქართველოს დამოუკიდებლობის დღის შეთავაზება · დამატებითი 12-საათიანი ოვერტაიმი</p>
              <h1>
          ...
          <div className="campaign-shell campaign-cta-band__inner">
            <FadeIn className="campaign-cta-band__copy">
              ...
              <p>
                ...
                გახანგრძლივდა 27 მაისის 14:59-მდე, შემდეგ კი ფასი ეტაპობრივად ბრუნდება სრულ ფასთან.
              </p>
