    ...
    <div className="campaign-page" style={{ minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "64px 24px" }}>
        ...
        <Section title="1. ზოგადი დებულებები">
          წინამდებარე პირობები არეგულირებს ურთიერთობას ო. ზაკალაშვილს (ი/მ) (ს/კ: 01001071740, მისამართი: მირიან მეფის ქუჩა, 11გ, ბინა #39, შემდგომში „კომპანია") და ვებგვერდის bitcamp.ge მომხმარებელს შორის.
          <br /><br />
