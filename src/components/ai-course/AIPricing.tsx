      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="relative overflow-hidden border-2 border-premium/50 shadow-xl">
            ...
            <div className="p-8 pt-12 sm:p-10">
              {/* Title */}
              ...
              <div className="text-center mb-8">
                <div className="flex items-center justify-center gap-3 mb-2">
                  ...
                  <Badge className="bg-red-100 text-red-700 border-red-200 hover:bg-red-100 hover:text-red-700">დაზოგე 68%</Badge>
                </div>
                <div className="flex items-baseline justify-center gap-1">
                  <span className="text-5xl sm:text-6xl font-bold text-text-primary">₾249</span>
