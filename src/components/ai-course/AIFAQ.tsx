...
export function AIFAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "ChatGPT-ს აქვს უფასო ვერსიაც, რაც დასაწყისისთვის საკმარისია. n8n-ს ასევე აქვს უფასო/სატესტო რეჟიმი. თუ გადაწყვეტთ, რომ პროფესიონალურად გინდათ მუშაობა, თვეში დაახლოებით ₾55-ის ინვესტიცია დაგჭირდებათ (რაც ერთ საათში ანაზღაურდება)."
    },
    {
